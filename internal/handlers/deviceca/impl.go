...
func (s *Server) CreateTrustedDeviceCACert(ctx context.Context, request CreateTrustedDeviceCACertRequestObject) (CreateTrustedDeviceCACertResponseObject, error) {
...
func (s *Server) GetTrustedDeviceCACertByIDAsPEM(ctx context.Context, request GetTrustedDeviceCACertByIDAsPEMRequestObject) (GetTrustedDeviceCACertByIDAsPEMResponseObject, error) {
...
func (s *Server) UpdateTrustedDeviceCACert(ctx context.Context, request UpdateTrustedDeviceCACertRequestObject) (UpdateTrustedDeviceCACertResponseObject, error) {
	// Read the PEM data from the request body
	pemData, err := io.ReadAll(request.Body)
	if err != nil {
		slog.Error("Failed to read request body", "error", err)
